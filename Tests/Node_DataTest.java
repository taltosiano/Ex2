...
class Node_DataTest {
   ...
   GeoLocation g = new Geo_Location(1,2,3);
    @Test
    void getLocation() {
        NodeData node1 =new Node_Data(1,g);
        Assertions.assertEquals(g ,node1.getLocation());
    ...
    void testToString() {
        NodeData node1 =new Node_Data(1,new Geo_Location(1,2,3));
        Assertions.assertEquals("Node_Data{_tag=0, _key=1, _weight=0.0, _info='', gl=1.0,2.0,3.0}",node1.toString());
        NodeData node2=new Node_Data((Node_Data) node1);
        Assertions.assertEquals("Node_Data{_tag=0, _key=1, _weight=0.0, _info='', gl=1.0,2.0,3.0}",node2.toString());
    }
}